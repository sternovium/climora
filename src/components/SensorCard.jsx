export default function SensorCard({ name = "Ruang Server", temperature, humidity, lastUpdated }) {
  const getStatus = (temp) => {
    if (temp == null) return { label: "Tidak ada data", cls: "normal", icon: "—" };
    ...
    <div className="sensor-card">
      ...
      <div className="sensor-card-body">
        ...
        <div className="sensor-card-header">
          ...
          <span className="sensor-card-sensor-id">DHT22 · Sensor-01</span>
        </div>
              ...
              {humidity != null && (
                <div className="sensor-card-humidity">
                  ...
                  <div>
                    ...
                    <div className="sensor-card-humidity-value">{humidity.toFixed(1)}%</div>
                  </div>
                </div>
              )}
            </div>
